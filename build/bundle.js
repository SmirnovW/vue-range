...
exports.default = {
	...
	methods: {
		...
		mouseMoveHandler: function mouseMoveHandler() {
			...
			this.positionX = Math.min(Math.max(0, event.pageX - this.$el.offsetLeft - this.$els.slider.offsetWidth / 2), this.$els.rail.offsetWidth - this.$els.slider.offsetWidth);
		...
		removeMouseMoveHandler: function removeMouseMoveHandler() {
			Vue.util.off(window, 'mousemove', this.mouseMoveHandler);
			Vue.util.off(window, 'mouseup', this.removeMouseMoveHandler);
			this.isActive = false;
		},
		_calculatePositionByStep: function _calculatePositionByStep(lastPositionX) {
			if (this.positionX <= Math.ceil(this.prevStep) || this.positionX >= Math.floor(this.nextStep)) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6d3c24e5", module.exports)
  } else {
    hotAPI.update("_v-6d3c24e5", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/vue-range.vue":5,"vue":3}]},{},[6]);
